...
import { BadgeCheck, ChevronRight, BookText } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="flex shrink-0 items-center justify-center transform-gpu">
            <Image
              src="/assets/profile.jpeg"
              alt="Piero Aguilar Anticona"
              width={160}
              height={160}
              priority
        ...
        <motion.div variants={itemVariants} className="space-y-5 sm:space-y-6">
          <h1 className="max-w-full text-[1.7rem] font-normal tracking-tight leading-tight sm:text-[2.05rem] md:text-[2.15rem]">
            ...
            <span className="text-[0.95em] font-light text-muted-foreground sm:text-[0.96em]">
              — Building Robust Systems, Shipping Clean Code.
            </span>
          </h1>
          <p className="text-base font-light leading-7 text-muted-foreground sm:text-lg sm:leading-8">
            ...
            — focused on microservices, DDD, hexagonal architecture,
            event-driven architecture and SOLID principles. Founder of PachaTech.
          </p>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 pt-2">
            ...
            <a
              href="https://drive.google.com/file/d/1YSu-CqjyqDdaGOimY6iOmUedJPsQQFnZ/view?usp=sharing"
              target="_blank"
              rel="noreferrer"
            >
              <Button
